...
Usage:
  ...
  python3 audit_vault.py --append '{"event": "probe", "severity": "WARNING"}' [--topic security.alerts.kernel]
"""
...
def main():
    ...
    parser.add_argument("--topic", default="security.alerts.kernel", help="Event topic")
